...
public class App {
    public static void main(String[] args) {
        ...
        try {
            // On initialise les repositories et services
            ...
            //On initialise les données de test
            initializeTestData(em);

            // On recherche de salles disponibles par créneau
            System.out.println("\n=== Test 1: Recherche de salles disponibles par créneau ===");
            testAvailableRooms(salleService);

            // On recherche multi-critères
    ...
    private static void initializeTestData(EntityManager em) {
        ...
        Equipement projecteur = new Equipement("Projecteur", "Projecteur HD de bonne qualité");
        Equipement ecran = new Equipement("Écran interactif", "Écran tactile 60 pouces");
        ...
        Utilisateur user1 = new Utilisateur("Salma", "Alami", "salma.alami@example.com");
        Utilisateur user2 = new Utilisateur("Ahmed", "Saphi", "ahmed.saphi@example.com");

        em.persist(user1);
        em.persist(user2);

        // On crée les salles
        Salle salle1 = new Salle("Salle A11", 30);
        salle1.setDescription("Salle de réunion standard");
        salle1.setBatiment("Bâtiment A");
        salle1.setEtage(1);
        salle1.addEquipement(projecteur);

        Salle salle2 = new Salle("Salle B22", 15);
        salle2.setDescription("Petite salle de réunion");
        salle2.setBatiment("Bâtiment B");
        salle2.setEtage(2);
        salle2.addEquipement(ecran);

        Salle salle3 = new Salle("Salle C33", 50);
        ...
        Salle salle4 = new Salle("Salle A22", 20);
        ...
        Salle salle5 = new Salle("Salle B33", 40);
    ...
    private static void testPagination(SalleService salleService) {
        ...
        // On crée un objet PaginationResult pour la première page
